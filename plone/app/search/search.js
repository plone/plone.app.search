...
(function ($) {
    ...
    $(function () {
        ...
        var Search, container, data;
        container = $('#search-results');

        $('#search-filter input.searchPage[type="submit"]').hide();

        Search = {
            // The globally available object with all the methods to handle
            // the search results
            getResults: function (data) {
                // Build an AJAX request to get results from a query defined
                // in 'data'. data assumes the string of parameters, not an 
                // Array.
            ...
            updateResults: function (data) {
                Search.getResults(data);
                Search.pushState(data);
            }
        };
