...
class TestPerformance100(Search100FunctionalTestCase):
    ...
    def test_performance_for_100_items(self):
        ...
        self.assertTrue('100 items matching your search terms' in browser.contents)
        ...
        new_end = time()
        self.assertTrue('<strong id="search-results-number">100</strong>' in browser2.contents)
...
class TestPerformance1000(Search1000FunctionalTestCase):
    ...
    def test_performance_for_1000_items(self):
        ...
        browser.open(portal_url+'/search?SearchableText=spam')
        old_end = time()
        self.assertTrue('1000 items matching your search terms' in browser.contents)
        old_time = old_end-old_start
        ...
        browser2.open(portal_url+'/@@search?SearchableText=spam')
        new_end = time()
        self.assertTrue('<strong id="search-results-number">1000</strong>' in browser2.contents)
